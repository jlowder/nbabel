...
(defun leapfrog (f c)
  "create a lambda representing the leapfrog algorithm. `F` is a function that calculates a star's instantaneous acceleration. `C` is the cluster."
  (lambda (i)
...
(defun main ()
  (let ((brk "=======================")
    ...
    (multiple-value-bind (e0 pe ke) (energy cluster)
      ...
      (let ((integrator (leapfrog (force-on-particle cluster) cluster)))
